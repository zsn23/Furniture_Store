...
switch (language) {
  ...
  return (
    ...
    <div className="col-12 col-md-6 d-flex justify-content-md-start justify-content-center mb-3 mb-md-0">
      <Link to='/' className='text-decoration-none'>
      <h2 className="fontStyling mt-3 text-center text-sm-end HandleHeading">FURNITURE HOP</h2>
  ...
  <small className="d-flex align-items-center LocationMyaccountHover_____">
    <Link to='/location' className='text-decoration-none'>
      ...
      <span className="LocationLogo"> <small> Location |</small></span>
    </Link>
  </small>
</div>
        ...
        <div className="d-flex align-items-center px-2">
          <small className="d-flex align-items-center LocationMyaccountHover_____">
            ...
            >
              ...
              <span className="LocationLogo"> <small> My Account |</small></span>
                {accountHovered && (
                <div className="dropdown-menu show account-dropdown">
                  <ul>
                    <li><Link to="/login" className="dropdown-item hover-underline">Sign In or Create Account</Link></li>
